...
function messageArea (selector, uploadurl, i18n, configuration) {
  ...
  var W = window, N = W.navigator, D = W.document,
     ...
     T8 = { speak:'Parler', type:'Ecrire', upload:'Joindre', back:'back', play:'play', pause:'pause', start:'Start', stop:'stop',
       label:'Veuillez joindre les fichiers correspondants', recording:'enregistrement...', playback:'Cliquez pour prévisualiser l enregistrement.', cancel:'Annuler', ok:'ok', 
       record:'Cliquez sur le microphone pour commencer l enregistrement', drag:'Joindre un fichier ici', confirm:'confirmer', ok:'ok',
       select:'Sélectionnez le fichier', audio:'%n a enregistré un message.', file:'%n a joint un fichier.', saved:'enregistré',
       error:'erreur', errorType:'Type de fichier non autorisé.', errorSize:'%n est plus grand que %s.', delete:'Supprimer',
       noSupport:'Audio API non supporté.', noPermission:'Pas d accès au microphone.', rename:'renommer', add:'ajouter', 
       confirmDelete:'Êtes-vous sur de vouloir supprimer cet élément définitivement?', noFile:'Aucun fichier reconnu.'},
